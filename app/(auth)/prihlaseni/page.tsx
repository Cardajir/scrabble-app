...
export default function PrihlaseniPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (error) {
        toast.error('Nespravny e-mail nebo heslo')
        return
      }
    ...
    <div className="min-h-screen paper-bg flex items-center justify-center px-4 py-16">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Prihlasit se</h1>
          <p className="text-muted-foreground text-sm mt-2">Zadejte sve prihlasovaci udaje</p>
        </div>
