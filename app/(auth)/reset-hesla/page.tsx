...
export default function ResetHeslaPage() {
  ...
  const onSubmit = async (data: ResetPasswordInput) => {
    ...
    try {
      ...
      if (error) {
        toast.error('Chyba pri odesilani e-mailu')
        return
      }
      ...
      <div className="min-h-screen paper-bg flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <div className="card-clubhouse rounded-2xl p-10">
            ...
            <h2 className="text-2xl font-bold mb-3">E-mail odeslan</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-8">
              Zkontrolujte svou e-mailovou schranku a kliknete na odkaz pro reset hesla.
            </p>
            <LinkButton variant="outline" className="w-full" href="/prihlaseni">
              Zpet na prihlaseni
            </LinkButton>
          </div>
        </div>
    ...
    <div className="min-h-screen paper-bg flex items-center justify-center px-4 py-16">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Reset hesla</h1>
          <p className="text-muted-foreground text-sm mt-2">Posleme vam odkaz pro reset hesla</p>
        </div>
